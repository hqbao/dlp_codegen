def train(dataset_name, image_shape, scale_sizes, anchor_sizes, iou_thresholds, anchor_samplings, epochs):
	...
	dataset_dir = '/Users/baulhoa/Documents/PythonProjects/datasets/object_detection'
	train_anno_file_path = dataset_dir+'/'+dataset_name+'/train.txt'
	train_image_dir = dataset_dir+'/'+dataset_name+'/train'
	ishape = image_shape
	ssizes = scale_sizes
	asizes = anchor_sizes
	...
	total_train_examples = dataset_info[dataset_name]['total_train_examples']
